...
def create_validation(validation_split=0.2):
    ...
    for f in os.listdir(r'D:\seed Classification  Model\train'):
        train_class_path= os.path.join(r'D:\seed Classification  Model\train', f)
        if os.path.isdir(train_class_path):
            validation_class_path= os.path.join(r'D:\seed Classification  Model\validation', f)
...
training_set = train_datagen.flow_from_directory(r'D:\seed Classification  Model\train',
                                                 target_size = (150, 150),
                                                 batch_size = 20,
...
test_set = test_datagen.flow_from_directory(r'D:\seed Classification  Model\validation',
                                            target_size = (150, 150),
                                            batch_size = 20,
                                            class_mode = 'categorical')
